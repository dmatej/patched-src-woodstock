...
public class ListboxTag extends UIComponentELTag {
    ...
    protected void setProperties(UIComponent component) {
        ...
        if (monospace != null) {
            component.setValueExpression("monospace", monospace);
        }
        if (multiple != null) {
    ...
    public void setToolTip (ValueExpression toolTip) {
      ...
      /**
     * Set attribute corresponding to the "monospace" property
     */
    private ValueExpression monospace = null;
    public void setMonospace (ValueExpression monospace) {
