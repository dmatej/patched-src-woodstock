...
public class PasswordFieldTag extends UIComponentELTag {
    ...
    protected void setProperties(UIComponent component) {
        ...
        if (trim != null) {
            component.setValueExpression("trim", trim);
        }
        if (onKeyDown != null) {
    ...
    public void setOnFocus (ValueExpression onFocus) {
     ...
     /**
     * Set attribute corresponding to the "trim" property
     */
    private ValueExpression trim = null;
    public void setTrim (ValueExpression trim) {
        this.trim = trim;
    }
     /**
    ...
    public void setRequired (ValueExpression required) {
     ...
     /**
     * Set attribute corresponding to the "password" property
     */
    private ValueExpression password = null;
