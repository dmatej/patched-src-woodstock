...
public class RadioButtonTag extends UIComponentELTag {
    ...
    protected void setProperties(UIComponent component) {
        ...
        if (selectedValue != null) {
            component.setValueExpression("selectedValue", selectedValue);
        }
        if (onKeyDown != null) {
    ...
    public void setOnFocus (ValueExpression onFocus) {
     ...
     /**
     * Set attribute corresponding to the "selectedValue" property
     */
    private ValueExpression selectedValue = null;
