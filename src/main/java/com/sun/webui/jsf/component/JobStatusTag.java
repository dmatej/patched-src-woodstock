...
public class JobStatusTag extends UIComponentELTag {
    ...
    protected void setProperties(UIComponent component) {
        ...
        if (numJobs != null) {
            component.setValueExpression("numJobs", numJobs);
        }
     }
    ...
    public void setOnDblClick (ValueExpression onDblClick) {
     ...
     /**
     * Set attribute corresponding to the "numJobs" property
     */
    private ValueExpression numJobs = null;
    public void setNumJobs (ValueExpression numJobs) {
