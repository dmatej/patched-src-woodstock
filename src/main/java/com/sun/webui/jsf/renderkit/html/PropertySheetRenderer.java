 ...
 */
@com.sun.faces.annotation.Renderer(@com.sun.faces.annotation.Renderer.Renders(componentFamily = "com.sun.webui.jsf.PropertySheet"))
public class PropertySheetRenderer extends javax.faces.render.Renderer {
    ...
    protected void renderJumpLinks(FacesContext context,
        ...
        // jump link area
        //
        int jumpLinksPerRow = numSections < 5 ? 2 : (numSections > 4 && numSections < 10 ? 3 : 4);
