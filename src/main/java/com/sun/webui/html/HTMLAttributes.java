 ...
 */
/* $Id: HTMLAttributes.java,v 1.1 2007-02-16 01:00:06 bob_yennaco Exp $
 */

package com.sun.webui.html;

public class HTMLAttributes {
    // Attributes
    //
    public static final String ABBR = "abbr"; //NOI18N
    public static final String ACCEPT = "accept"; //NOI18N
    public static final String ACCEPT_CHARSET = "accept-charset"; //NOI18N
    public static final String ACCESSKEY = "accesskey"; //NOI18N
    ...
    public static final String AXIS = "axis"; //NOI18N
    ...
    public static final String CHAROFF = "charoff"; //NOI18N
    ...
    public static final String DATETIME = "datetime"; //NOI18N
    public static final String DECLARE = "declare"; //NOI18N
    public static final String DEFER = "defer"; //NOI18N
    public static final String DIR = "dir"; //NOI18N
    public static final String DISABLED = "disabled"; //NOI18N
    ...
    public static final String HREFLANG = "hreflang"; //NOI18N
    public static final String HSPACE = "hspace"; //NOI18N
    public static final String HTTP_EQUIV = "http-equiv"; //NOI18N
    ...
    public static final String LONGDESC = "longdesc"; //NOI18N
    ...
    public static final String ONBLUR = "onblur"; //NOI18N
    public static final String ONCHANGE = "onchange"; //NOI18N
    public static final String ONCLICK = "onclick"; //NOI18N
    public static final String ONDBLCLICK = "ondblclick"; //NOI18N
    public static final String ONFOCUS = "onfocus"; //NOI18N
    public static final String ONKEYDOWN = "onkeydown"; //NOI18N
    public static final String ONKEYPRESS = "onkeypress"; //NOI18N
    public static final String ONKEYUP = "onkeyup"; //NOI18N
    public static final String ONLOAD = "onload"; //NOI18N
    public static final String ONMOUSEDOWN = "onmousedown"; //NOI18N
    public static final String ONMOUSEMOVE = "onmousemove"; //NOI18N
    public static final String ONMOUSEOUT = "onmouseout"; //NOI18N
    public static final String ONMOUSEOVER = "onmouseover"; //NOI18N
    public static final String ONMOUSEUP = "onmouseup"; //NOI18N
    public static final String ONRESET = "onreset"; //NOI18N
    public static final String ONSELECT = "onselect"; //NOI18N
    public static final String ONSUBMIT = "onsubmit"; //NOI18N
    public static final String ONUNLOAD = "onunload"; //NOI18N
    ...
    public static final String SCHEME = "scheme"; //NOI18N
    ...
    public static final String SUMMARY = "summary"; //NOI18N
    public static final String TABINDEX = "tabindex"; //NOI18N
